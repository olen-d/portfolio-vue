...
<template>
  <div id="admin-projects-form">
    ...
    <form id="admin-projects-form" enctype="multipart/form-data">
      ...
      />
      <TextareaGeneric
        errorMessage="Please enter a valid challenge description"
        inputName="challenge"
        labeltext="Project Challenge"
        placeholder="Describe the challenge the project is meant to address..."
        :initialValue="updateProjectData.challenge || null"
        :rows="6"
        :shouldClearInput="shouldClearInputs"
        @change-form-values="updateFormValues($event)" 
        @remove-form-values="removeFormValues($event)"
